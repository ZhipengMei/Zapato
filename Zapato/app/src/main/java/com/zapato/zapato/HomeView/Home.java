   ...
   */
        ...
        searchTab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(com.zapato.zapato.HomeView.Home.this, SearchActivity.class));
                resetMarker(1);
            }
        });
        cameraTab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(com.zapato.zapato.HomeView.Home.this, NewPostActivity.class));
                resetMarker(2);
            }
        });
    ...
    public void resetMarker(int mark){
        ...
        switch (mark){
            ...
            default: Toast.makeText(com.zapato.zapato.HomeView.Home.this, "reset marker error", Toast.LENGTH_SHORT);
                break;
        }
